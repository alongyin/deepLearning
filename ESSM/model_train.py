...
def train_model(cate_feature_dict,user_cate_feature_dict,item_cate_feature_dict,train_data,val_data):
    ...
    ctcvr_model.compile(optimizers=opt,loss=["binary_crossentropy","binary_crossentropy"],loss_weights=[1.0,1.0],metrics=[])
    ...
    earlystopping = EarlyStopping(monitor='val_loss',min_delta=0.0001,patience=8,verbos=1,mode='auto')
